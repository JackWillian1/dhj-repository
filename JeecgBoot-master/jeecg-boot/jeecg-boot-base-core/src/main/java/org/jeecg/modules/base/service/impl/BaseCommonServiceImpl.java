...
import org.jeecg.modules.producer.LogProducer;
...
public class BaseCommonServiceImpl implements BaseCommonService {
    ...
    public void addLog(String logContent, Integer logType, Integer operatetype, LoginUser user) {
        ...
        // author:DHJ
        //String loginTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(sysLog.getCreateTime());
        // 构造 JSON 字符串
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("realName",sysLog.getUserid());
        jsonObject.put("role",sysLog.getUsername());
        jsonObject.put("action",sysLog.getLogType());
        jsonObject.put("loginTime",sysLog.getCreateTime());
        String jsonToQueue = jsonObject.toJSONString();
        // String json = "{\"role\":\"" + sysLog.getUsername() + "\",\"realName\":\"" +sysLog.getUserid()+ "\",\"action\":\"" +sysLog.getLogType()+ "\",\"loginTime\":\"" + loginTime + "\"}";
        logProducer.sendLog(jsonToQueue);
        //
